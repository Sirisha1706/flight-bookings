...
import Header11 from "@/components/header/header-10";
import DefaultFooter from "@/components/footer/footer-2";
import MainFilterSearchBox from "@/components/hero/MainFilterSearchBox.jsx";
...
const index = () => {
  const [resultsCount, setResultsCount] = useState('256');
  return (
    <>
        ...
        <div className="container">
          <div className="row y-gap-30">
            ...
            <div className="col-xl-9 ">
              <TopHeaderFilter resultsCount={resultsCount}/>

              <div className="row">
                <FlightProperties setResultsCount={setResultsCount}/>
              </div>
              {/* End .row */}
              <Pagination />
            </div>
